# peremuan 12
## tugas praktikum 8 
## __oop__  __(object oriented progaming)__
...
1. Untuk memanggil fungsi dengan nama "os".
    ...
    import os
    ```
2. Membuat class `data_mahasiswa` dengan atributnya, yaitu nama, nim, tugas, uts dan uas.
    ```python
    class data_mhsw:
        nama=""
        nim=""
...
![gambar1](image/ss5.png)

## diagram class 

![gambar2](image/ssdiagramclass.png)